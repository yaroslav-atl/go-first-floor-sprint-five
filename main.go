...
func (t Training) meanSpeed() float64 {
	// Преобразуем продолжительность в часы и вычисляем среднюю скорость
...
func (w Walking) Calories() float64 {
	...
	return ((CaloriesWeightMultiplier*w.Weight + (speed*speed/height)*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours)
}
